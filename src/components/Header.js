...
function Header() {
  ...
  return (
    ...
    >
      ...
      <div className="text-white font-mono font-bold text-center md:text-left">
        ...
        <h1 className={`${animated ? "" : "translate-y-10 opacity-0"} transform transition duration-1000 ease-in-outfont-bold text-2xl text-gray-500`}>
